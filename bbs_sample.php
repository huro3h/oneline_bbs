...
<!--                   <li class="hidden">
  ...
  <div class="container">
    ...
    <form action="bbs_sample.php" method="post">
      ...
      <div class="col-md-8 content-margin-top">
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                <a href="bbs_sample.php?action=edit&id=<?php echo $post['id'];?>">
                ...
                <div class="timeline-label">
                    ...
                    <a href="bbs_sample.php?action=delete&id=<?php echo $post['id'];?>"><i class="fa fa-trash fa-lg"></i></a>
                </div>
            </div>
